                ...
                <Grid container spacing={24}>
                    <Grid item xs={12} md lg xl>
                        <Card style={{background:"url(5.jpg)", backgroundSize: "cover" }}>
                            ...
                            {/* </CardMedia> */}
                            <CardActions>
                                <Button variant="contained" size="large" href={this.state.wedurl} target="_blank">Take me to Wedding Venue</Button>
                            </CardActions>
                        </Card>
                    </Grid>
                    <Grid item xs={12} md lg xl>
                        <Card style={{background:"url(14.jpg)", backgroundSize: "cover" }}>
                            ...
                            {/* </CardMedia> */}
                            <CardActions>
                                <Button variant="contained" size="large" href={this.state.recurl} target="_blank">Take me to Reception Venue</Button>
                            </CardActions>
                        </Card>
                    </Grid>
                </Grid>
